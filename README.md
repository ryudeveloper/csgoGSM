...
[csgoGSM](https://ryudev.net) is the command-line tool for quick, simple deployment and management of CSGO game servers.
...
csgoGSM will run on popular distros as long as the minimum requirements are met.
